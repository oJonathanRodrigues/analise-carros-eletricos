...
export default function Slogan() {
    return (
        <div className="flex flex-col justify-center gap-5 p-3">
            ...
            NeoCharge, empresa especializada em recarga de veículos elétricos, o número de carros com 
            algum tipo de eletrificação no país saltou de 3.119 em 2015 para 120.566 em 20221. Esse 
            crescimento reflete a maior oferta de modelos e a busca por alternativas mais sustentáveis e econômicas.
            </div>
        </div>
    )
}
